"""
Django settings for testret_2 project.
...
WSGI_APPLICATION = 'testret_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testret_2 API",
    "DESCRIPTION": "API documentation for testret_2 App",
    "VERSION": "v1",
}
